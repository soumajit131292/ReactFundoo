...
export function setRemainder(abc,noteId)
{
    ...
    return axios.post('http://localhost:8080/notes/remainder?datetime='+datetime+'&noteId='+noteId,null,{ headers : headers });
}
export function deleteRemainder(noteId)
{
    return axios.delete('http://localhost:8080/notes/deleteremainder?noteId='+noteId,{ headers : headers });
}
...
{
    return axios.put('http://localhost:8080/notes/changePin?noteId='+noteId,null,{ headers : headers });
}
export function setColour(colorCode,noteId)
{
    console.log(colorCode)
    console.log(noteId)
    return axios.post('http://localhost:8080/notes/setcolor/'+colorCode+'/'+noteId,null,{ headers : headers });
}
export function getColabUser(noteId){
   
    return axios.get('http://localhost:8080/collaborator/colabuser/'+noteId,{ headers : headers });
}